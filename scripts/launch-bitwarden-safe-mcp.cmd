...
if "%~1"=="" (
  echo Bitwarden Agent Safe could not start: missing MCP server path. 1>&2
  exit /b 64
)
...
echo Bitwarden Agent Safe could not find a Node.js 22+ runtime. Reinstall or update Codex. 1>&2
exit /b 127
